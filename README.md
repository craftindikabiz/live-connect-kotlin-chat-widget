...
```kotlin
dependencies {
    implementation("com.github.craftindikabiz:live-connect-kotlin-chat-widget:v1.0.11")
}
```
...
`https://jitpack.io/#craftindikabiz/live-connect-kotlin-chat-widget/v1.0.11` in a browser and click **Get it** to force a rebuild.
